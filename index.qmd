...
# Investment Simulation Challenge
...
**Comments on the Results:** {.results}
...
![Distribution of Final Balances - 100 Simulations](originally.png)

### 95% Grade {.alert .alert-success}
...
```
**Answer:** 26% chance of having greater than $1,000 at age 55. {.results}

---

## Conclusion

This simulation challenge demonstrates several important concepts in financial modeling and risk analysis:

- **Expected Value vs. Probability**: Even with positive expected returns, the probability of success can be low due to high volatility
- **Risk Management**: The multiplicative nature of gains and losses creates extreme outcomes
- **Monte Carlo Simulation**: A powerful tool for understanding complex probabilistic systems
- **Investment Strategy**: High-risk strategies may have favorable expected values but poor probability of success

The analysis shows that while the investment game has a positive expected value, the high volatility makes it a risky strategy for most investors.

---

<div class="footer">
<p><strong>Investment Simulation Challenge</strong> | Monte Carlo Analysis</p>
<p>Generated with Quarto • R • Statistical Modeling</p>
</div>

### 100% Grade {.alert .alert-danger}
